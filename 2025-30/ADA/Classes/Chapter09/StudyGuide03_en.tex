...
\usepackage{amsmath, amssymb, hyperref, graphicx, geometry, minted, xcolor, booktabs}
\hypersetup{
  colorlinks=true,
  linkcolor=blue,
  filecolor=magenta,
...
\title{Study Guide 3: Algorithms for Verifying Solutions and Efficient Improvements}
...
\begin{itemize}
    \item \textbf{Cormen, T. H., Leiserson, C. E., Rivest, R. L., and Stein, C.} \textit{Introduction to Algorithms}, 4th ed. MIT Press, 2009 \cite{cormen01introduction}.
        \begin{itemize}
            \item Chapter 1: The Role of Algorithms in Computing – Basic concepts of algorithms and pseudocode.
        \end{itemize}

    \item \textbf{Brassard, G., and Bratley, P.} \textit{Fundamentals of Algorithmics}. Prentice Hall, 1996 \cite{10.5555/208078}.
        \begin{itemize}
    ...
    \item \textbf{Skiena, S. S.} \textit{The Algorithm Design Manual}, 2nd ed. Springer, 2008 \cite{Skiena2020Algorithm}.
        \begin{itemize}
            \item Chapter 13: How to Design Algorithms – Includes practical improvement techniques.
        \end{itemize}

    \item \textbf{Levitin, A.}  \textit{Introduction to The Design \& Analysis of Algorithms}. Pearson, 2012 \cite{10.5555/579301}.
        \begin{itemize}
