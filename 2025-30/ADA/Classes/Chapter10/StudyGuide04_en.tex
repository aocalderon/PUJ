...
\usepackage{amsmath, amssymb, hyperref, graphicx, geometry, minted, xcolor, booktabs, threeparttable}
\hypersetup{
  colorlinks=true,
  linkcolor=blue,
  filecolor=magenta,
...
\title{Study Guide 4: Identifying Problem Types and Advanced Strategies}
...
In the following \href{https://drive.google.com/file/d/14AJw2GU4XWm-T1sgmccPmU0ZpVkizBDJ/view?usp=sharing}{link}, you can download and listen to a Gemini podcast that discusses the main topics covered in this study guide. Please note that the podcast is in Spanish.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
