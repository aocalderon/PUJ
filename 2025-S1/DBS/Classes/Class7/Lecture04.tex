...
\begin{frame}[fragile]{Dangerous in Natural Join}
    ...
    \vspace{-5mm}
    \begin{FlushRight}
        \Large \textcolor{red}{\textbf{Incorrect!}}
    \end{FlushRight}
\end{frame}
...
\begin{frame}{Outer Join}
    \begin{itemize}
        ...
        \item Computes the join and then adds tuples form one relation that does not match tuples in the other relation to the result of the join.
