REGLAS DE JUEGO - ADMINISTRACION DE BASES DE DATOS:

#############
1. Calificación:
*Talleres guiados y Quizzes -> 20%
*Proyecto -> 20%
*Parciales 1 -> 20% 
*Parciales 2 -> 20% 
*Parciales 3 -> 20% 
...
#############
2. Horario de Clases:
*Las clases están programadas los días Martes y Jueves de 09:00am a 11:00am, cada semana durante el primer semestre académico del 2025.
*El inicio de la clase será a más tardar 15 minutos después de la hora programada con el fin de facilitar el desplazamiento y llegada de todos los estudiantes al aula de clase, y finalizará 10 minutos antes de la hora programada igualmente para facilitar el desplazamiento de los estudiantes a sus siguientes actividades académicas. 
...
#############
4. Plataformas utilizadas para el desarrollo del curso:
...
*Los archivos entregables (talleres, avances de proyecto, etc), así como las dispositivas de clases serán gestionados por la plataforma de BrigthSpace.
...
*La calificación de talleres y proyectos ES DE MANERA GRUPAL.
*La calificación de quizzes y parciales ES DE MANERA INDIVIDUAL.
...
#############
7. Desarrollo y entrega de talleres:
*El desarrollo de los talleres se realizará durante la sesión de clase.
...
#############
8. Desarrollo y entrega de Evaluaciones:
...
*El máximo plazo de entrega de los parciales es el día programado a las 11:00am sin excepción.
*Para quizzes y parciales es permitido el uso de calculadora NO PROGRAMABLE, NO CIENTIFICA AVANZADA, Y NO GRAFICADORA.


#############
9. Contacto y horarios de atención fuera de clase:
*La comunicación Estudiantes-Profesor se hará por medio de correo electrónico: acald013@ucr.edu (Andres Calderon) o por el chat de Teams.
*Cualquier correo al profesor debe incluir al inicio del asunto la siguiente combinación de caracteres: '[ADA]'. De lo contrario un gatito morirá en algun lugar del mundo.
*Todo correo o mensaje de Teams será contestado en HORARIO LABORAL, es decir, de 8:00am a 6:00pm.
*El horario de atención a estudiantes en oficina será los días Jueves de 2:00pm a 4:00pm durante el trascurso del semestre académico. La atención se realizará por orden de llegada.