...
\input{sections/entities_and_columns}

\section{The Three Levels of E-R Models}
\input{sections/three_levels}

\section{Key and Relationships}
\input{sections/key_and_relationships}

\section{Database Views}
\input{sections/db_views}

\section{Triggers and Stored Procedures}
\input{sections/triggers_procedures}
