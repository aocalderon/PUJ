...
Guess what? In addition to Pentaho Data Integration, there are plenty of alternatives, both open-source and commercial. Read the following \href{https://drive.google.com/file/d/1rtwb_Rc7QxYul8SMOHqUgbfXHlMoksyD/view?usp=sharing}{document} about ETL alternatives and choose one of them. Then, write a well-structured tutorial report similar to the one you just completed using PDI, but using your chosen alternative this time.

We expect you to submit your report by \textbf{14 days} from now before the lab on that day.
