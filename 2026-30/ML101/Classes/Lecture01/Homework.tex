...
\begin{enumerate}
    \item \href{https://drive.google.com/file/d/1ZDwhMAk2n3qg3iXuIGzk_8Di6QqlwU6z/view?usp=sharing}{\textit{Understanding Machine Learning: From Theory to Algorithms}} by Shai Shalev-Shwartz and Shai Ben-David.

    \item \href{https://drive.google.com/file/d/1mT_na6JaKM1HbijdOQzESZwVWLdtwghc/view?usp=sharing}{\textit{An Introduction to Statistical Learning: with Applications in R}} (or Python) by Gareth James, Daniela Witten, Trevor Hastie, Robert Tibshirani, and Jonathan Taylor.

    \item \href{https://drive.google.com/file/d/1PCLoOU9XrA90_-roCY1aiSZItjLDDuGI/view?usp=sharing}{\textit{Probabilistic Machine Learning: An Introduction}} by Kevin P. Murphy.
\end{enumerate}
