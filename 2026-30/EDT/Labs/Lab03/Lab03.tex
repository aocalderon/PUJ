...
You must submit a well-formatted report in \textbf{PDF} format detailing the methodology requested in Section \ref{sec:class}, including the final \textbf{map layout} of your classified image. Additionally, please include the summary requested in Section \ref{sec:asses}. The report must be uploaded to Brightspace\texttrademark\ no later than \textbf{14 days} from now, before the start of the session on that day.
