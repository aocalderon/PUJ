...
\begin{enumerate}
    ...
    \item \textbf{Active Tectonics and Mountain Geohazards}
    \begin{itemize}
        \item \textbf{North-Central Venezuela Earthquake Doublet (June 2026):}
            \begin{itemize}
                \item \textbf{The Event:} A powerful seismic sequence consisting of Mw 7.2 and Mw 7.5 strike-slip events ruptured along the San Sebastián and Boconó fault systems, causing severe ground displacement and infrastructure collapse across Yaracuy, Carabobo, and the coastal towns of La Guaira.
                \item \textbf{Project Focus:} Ideal for radar interferometry (DInSAR) and urban damage mapping. Students can process Sentinel-1 pairs to measure ground displacement and detect structural failures in coastal towns using SAR coherence loss or optical image differencing.
            \end{itemize}

            \item \textbf{Western Colombia Earthquake, Chocó / Eje Cafetero (August 2026):}
            \begin{itemize}
                \item \textbf{The Event:} A major Mw 7.4 intermediate-depth earthquake centered near San José del Palmar (Chocó) shook western and central Colombia, triggering mass movements along the Western Cordillera and damaging urban infrastructure in Pereira, Manizales, and Cali.
                \item \textbf{Project Focus:} Combines landslide mapping and urban damage assessment. Students will use Sentinel-2 to detect co-seismic landslides via $\Delta\text{NDVI}$ and apply Sentinel-1 SAR coherence loss or supervised classification to evaluate urban structural damage.
            \end{itemize}

            \item \textbf{Trishuli River Flash Flood and Debris Flow, Nepal (August 2026):}
            \begin{itemize}
                \item \textbf{The Event:} A sudden high-altitude glacial mass detachment triggered a massive outburst and debris flow along the Langtang Lirung / Trishuli river corridor, sweeping away bridges, hydropower infrastructure, and settlements across Rasuwa and Nuwakot districts.
                \item \textbf{Project Focus:} Ideal for rapid disaster mapping in complex mountain topography. Students can compute water and sediment indices (such as MNDWI and NDWI) alongside SAR amplitude change to delineate the debris flow path and scouring footprint through narrow gorges, even under persistent monsoon cloud cover.
            \end{itemize}
        \end{itemize}
...
\subsection*{Phase 4: Post-Processing, Accuracy Assessment \& Reporting}
\begin{itemize}
...
\begin{description}
    ...
    \item[Partial Delivery (Phases 1, 2 \& 3):] Focus on Problem Definition, Data Acquisition, Pre-processing \& Initial Image Processing. \textbf{[after 3 weeks].}


    \item[Final Delivery (Phases 3 \& 4) and Defense:] Focus on Post-Processing, Accuracy Assessment \& Reporting.  The \textbf{Complete Technical Report} abd the \textbf{Oral Presentation}. \textbf{[after 2 weeks].}
