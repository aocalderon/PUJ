...
\begin{frame}{Remote Sensing and Image Interpretation}
    \centering
    \includegraphics[height=0.7\textheight]{figures/book_cover} \\
    \vspace{1mm}
    {
        \footnotesize
        Content has been extracted from \textit{Remote Sensing and Image Interpretation}, Seventh Edition. Wiley. By Thomas Lillesand, Jonathan Chipman \& Ralph Kiefer, 2015. Visit \href{https://tinyurl.com/2uyfu8ab}{https://www.wiley.com/} for more info.\\
    }
\end{frame}
