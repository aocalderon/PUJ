...
\begin{frame}{Database System Concepts}
    \centering
    \includegraphics[width=0.375\textwidth]{figures/book_cover.jpg} \\
    \vspace{5mm}
    {
        \tiny
...
\begin{frame}{SQL Parts and Support}
    \begin{itemize}
        \item Read, Update, Delete -- the DML provides the ability to query information from the database and to insert tuples into, delete tuples from, and modify tuples in the database.
...
\begin{frame}[fragile]{The Rename Operation}
    \begin{itemize}
        ...
        $$
            instructor \text{ \texttt{AS} } T \equiv instructor \text{ } T
        $$
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Aggregate Functions – Group By}
    ...
    \begin{minipage}{.60\textwidth}
        \centering
        \includegraphics[width=0.7\textwidth, trim={8.5cm 16.5cm 5cm 4.75cm}, clip]{figures/db_agg}
    \end{minipage}
    \begin{minipage}{.30\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth, trim={10cm 5cm 7cm 18cm}, clip]{figures/db_agg}
    \end{minipage}
\end{frame}
