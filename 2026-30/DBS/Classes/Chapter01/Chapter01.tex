...
\begin{itemize}
    ...
    \begin{itemize}
        \item Sales: \pause customers, products, purchases.
        \item Accounting: \pause payments, receipts, assets.
        \item Human Resources: \pause Information about employees, salaries, payroll taxes.
        \item Manufacturing: \pause management of production, inventory, orders, supply chain.
    \end{itemize}
    \item Banking and Finance:
    \begin{itemize}
        \item \pause Customer information, accounts, loans, and banking transactions.
        \item \pause Credit card transactions.
        \item Finance: \pause sales and purchases of financial instruments (e.g. stocks and bonds, real-time market data, ...)
    \end{itemize}
    \item Universities: \pause
    \begin{itemize}
...
\begin{frame}{Database Applications Examples (Cont.)}
    \begin{itemize}
        \item Airlines: \pause reservations, schedules
        \item Telecommunication: \pause records of calls, texts, data usage, generating bills.
        \item Web-based services: \pause
        \begin{itemize}
            \item Online retailers: order tracking, customized recommendations.
            \item Online advertisements.
        \end{itemize} \pause
        \item Navigation systems: \pause locations of places of interest, routes, transport systems, etc.
        \pause
...
\begin{frame}{Relational Data Model}
    ...
    \begin{tikzpicture}[remember picture,overlay]   %% use here too
        \node[] at (3, 6.75) {\tiny Column};
        \draw[red,thick,->] (3,6.68) -- (3,6.3);
        \node[] at (7.75, 0.9) {\tiny Row};
        \draw[blue,thick,->] (7.5, 0.9) -- (7.05, 0.9);
    \end{tikzpicture}
\end{frame}

\begin{frame}{A Sample Relational Database}
    \centering 
    \includegraphics[width=0.3\textwidth, trim={7.25cm 10.5cm 6.75cm 4cm}, clip]{figures/db}
\end{frame}
...
\begin{frame}{Levels of Abstraction}
    ...
    \centering 
    \includegraphics[width=0.65\textwidth, trim={7.25cm 17.5cm 4.75cm 4cm}, clip]{figures/arch}
\end{frame}
...
\begin{frame}{Query Processing}
    ...
    \end{itemize}
    \centering 
    \includegraphics[width=0.7\textwidth, trim={5.25cm 16.25cm 4.9cm 4.5cm}, clip]{figures/qp}
\end{frame}
...
\begin{frame}{TDT5FTOTC}
    \centering
    \includegraphics[width=0.35\textwidth]{figures/td}\\
...
\begin{frame}{TDT5FTOTTC}
    \centering
    \includegraphics[width=\textwidth]{figures/tim}
\end{frame}
