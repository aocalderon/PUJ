...
\begin{frame}{Keys}
    \begin{itemize}
        \item $r = $ relation; $R = $ set of attributes; $r(R) =$ a relation $r$ described by a set of attributes $R$.
        \item Let $K \subseteq R$.
        \item $K$ is a \textbf{superkey} of $R$ if values of $K$ are sufficient to identify a unique tuple of each possible in $r(R)$.
        \begin{itemize}
...
\begin{frame}{Relational Query Languages}
    \begin{itemize}
        \item ``Pure''\footnote{``Pure'' refers to languages that are purely mathematical and formal models} languages:
        \begin{itemize}
