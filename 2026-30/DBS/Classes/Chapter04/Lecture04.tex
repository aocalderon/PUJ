...
\begin{frame}{Student Relation}
    \centering
    \includegraphics[width=0.65\textwidth, trim={8cm 4.5cm 5cm 16cm}, clip]{pages/nj1.pdf}
\end{frame}

\begin{frame}{Takes Relation}
    \centering
    \includegraphics[width=0.575\textwidth, trim={4.5cm 12cm 5.5cm 4.5cm}, clip]{pages/nj2.pdf}
\end{frame}

\begin{frame}{Student Natural Join Takes}
    \centering
    \includegraphics[width=0.775\textwidth, trim={3cm 12cm 3cm 4.5cm}, clip]{pages/nj3.pdf}
\end{frame}
...
\begin{frame}{SQL Join Types}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/joins}
    \toRight{\url{https://codebl0g.wordpress.com/2019/03/23/sql-join-type-examples/}}
\end{frame}
...
\begin{frame}[fragile]{Roles Example}
    ...
    \begin{itemize}
        \item[ ]
            \begin{minted}
            [tabsize=4, obeytabs, frame=lines, framesep=1mm, baselinestretch=1.2, bgcolor=LightGray, fontsize=\scriptsize]{sql}
CREATE ROLE instructor;
