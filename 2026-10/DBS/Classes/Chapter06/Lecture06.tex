...
\title[E-R Models]{Database System Concepts, $7^{th}$ Edition \\ Chapter 6: Database Design Using the E-R Model}
...
\begin{frame}{Relationship Sets (Cont.)}
    ...
    \end{itemize}
    \centering
    \includegraphics[trim={6.50cm 5cm 6.00cm 17.50cm}, clip, width=0.6\textwidth]{figures/p246}
\end{frame}
...
\begin{frame}{Relationship Sets (Cont.)}
    ...
    \bigskip
    \centering
    \includegraphics[trim={4.80cm 2cm 6.5cm 8cm}, clip, width=0.8\textwidth]{figures/attr_rel}
\end{frame}

\begin{frame}{Relationship Sets with Attributes}
    \vspace{20mm}
    \centering
    \includegraphics[trim={5.10cm 4cm 3.50cm 5.5cm}, clip, width=0.9\textwidth]{figures/attr_rel2}
\end{frame}
...
\begin{frame}{Representing Complex Attributes in ER Diagram}
    \centering
    \includegraphics[trim={5cm 15.25cm 5cm 4cm}, clip, width=0.75\textwidth]{figures/p252}
\end{frame}
...
\begin{frame}{Mapping Cardinalities}
    \centering
    \includegraphics[trim={6.75cm 17.5cm 3.75cm 4cm}, clip, width=0.7\textwidth] {figures/p253}
...
\begin{frame}{Mapping Cardinalities (Cont.)}
    \centering
    \includegraphics[trim={6.75cm 5cm 3.75cm 17cm}, clip, width=0.7\textwidth]{figures/p253}
    \begin{tabularx}{\textwidth}{@{} Y Y @{}}
...
\begin{frame}{Weak Entity Sets (Cont.)}
    \begin{itemize}
        ...
        %\item Note that the relational schema we eventually create from the entity set \texttt{section} does have the attribute \textit{course\_id}, for reasons that will become clear later, even though we have dropped the attribute \textit{course\_id} from the entity set \texttt{section}.
    \end{itemize}
\end{frame}
...
\begin{frame}{Expressing Weak Entity Sets}
    ...
    \end{itemize}
    \centering
    \includegraphics[trim={5cm 4.5cm 5cm 19.5cm}, clip, width=0.8\textwidth]{figures/p260}
\end{frame}
...
\begin{frame}{Redundant Attributes}
    ...
    \end{itemize}
    \centering
    \includegraphics[trim={5cm 2cm 5cm 13.5cm}, clip, width=0.7\textwidth]{figures/redundant_attr}
\end{frame}

\begin{frame}{E-R Diagram for a University Enterprise}
    \centering
    \includegraphics[trim={4.55cm 10.80cm 4.00cm 4.85cm}, clip, width=0.975\textheight]{figures/p264}
\end{frame}
...
\begin{frame}{Specialization Example}
    ...
    \end{itemize}
    \centering
    \includegraphics[trim={6cm 16cm 4cm 4.8cm}, clip, width=0.75\textwidth]{figures/specialization}
\end{frame}
...
\begin{frame}{Aggregation}
    ...
    \end{itemize}
    \centering
    \includegraphics[trim={4cm 4.25cm 4cm 16cm}, clip, width=0.75\textwidth]{figures/redundat_relationships}
\end{frame}
...
\begin{frame}{Aggregation (Cont.)}
    ...
    \end{itemize}
    \centering
    \includegraphics[trim={2cm 15cm 2cm 4cm}, clip, width=0.75\textwidth]{figures/aggregation_relationships}
\end{frame}
...
\begin{frame}{Common Mistakes in E-R Diagrams}
    ...
    \end{itemize}
    \centering
    \includegraphics[trim={4cm 16cm 4cm 4cm}, clip, width=0.85\textwidth]{figures/incorrect_use}
\end{frame}

\begin{frame}{Common Mistakes in E-R Diagrams (Cont.)}
    \centering
    \includegraphics[trim={5.5cm 14cm 2.4cm 4.5cm}, clip, width=0.85\textwidth]{figures/incorrect_use2}
\end{frame}

\begin{frame}{Entities vs. Attributes}
    \begin{itemize}
        \item Use of entity sets vs. attributes:
        \includegraphics[trim={5cm 20.30cm 4cm 4.75cm}, clip, width=0.8\textwidth]{figures/phones}
...
\begin{frame}{Converting Non-Binary Relationships to Binary Form}
    ...
    \begin{itemize}
        ...
        \end{enumerate}
    \end{itemize}
    \includegraphics[trim={5cm 4.5cm 4.75cm 19cm}, clip, width=0.9\textwidth]{figures/ternary}
\end{frame}
...
\begin{frame}{Summary of Symbols Used in E-R Notation}
    \centering
    \includegraphics[trim={5.45cm 8.75cm 5.05cm 4.8cm}, clip, height=0.9\textheight]{figures/symbols}
\end{frame}

\begin{frame}{Alternative ER Notations}
    \centering
    \includegraphics[trim={6.25cm 12cm 3.63cm 4.6cm}, clip, height=0.9\textheight]{figures/alternative_notations}
\end{frame}
...
\begin{frame}{ER vs. UML Class Diagrams}
    \centering
    \includegraphics[trim={5cm 9cm 3.63cm 4.6cm}, clip, height=0.9\textheight]{figures/uml}
\end{frame}
