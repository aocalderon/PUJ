...
\begin{frame}{Database System Concepts}
    \centering
    \includegraphics[width=0.36\textwidth]{figures/book_cover.jpg} \\
    \vspace{5mm}
    {
        \tiny
...
\begin{frame}{Mapping Cardinalities}
    \centering
    \includegraphics[trim={6.75cm 17.5cm 3.75cm 4cm}, clip, width=0.75\textwidth]{figures/p253}
...
\begin{frame}{Mapping Cardinalities}
    \centering
    \includegraphics[trim={6.75cm 5cm 3.75cm 17cm}, clip, width=0.75\textwidth]{figures/p253}
    \begin{tabularx}{\textwidth}{@{} Y Y @{}}
...
\begin{frame}{E-R Diagram for a University Enterprise}
    \centering
    \includegraphics[trim={4.55cm 10.80cm 4.00cm 4.85cm}, clip, height=0.9\textheight]{figures/p264}
\end{frame}
...
\begin{frame}{Specialization Example}
    ...
    \end{itemize}
    \centering
    \includegraphics[trim={6cm 16cm 4cm 4.8cm}, clip, width=0.775\textwidth]{figures/specialization}
\end{frame}
...
\begin{frame}{Aggregation}
    ...
    \end{itemize}
    \centering
    \includegraphics[trim={4cm 4.25cm 4cm 16cm}, clip, width=0.875\textwidth]{figures/redundat_relationships}
\end{frame}
...
\begin{frame}{Aggregation (Cont.)}
    ...
    \end{itemize}
    \centering
    \includegraphics[trim={2cm 15cm 2cm 4cm}, clip, width=0.875\textwidth]{figures/aggregation_relationships}
\end{frame}
...
\begin{frame}{Common Mistakes in E-R Diagrams}
    ...
    \end{itemize}
    \centering
    \includegraphics[trim={4cm 16cm 4cm 4cm}, clip, width=0.8\textwidth]{figures/incorrect_use}
\end{frame}

\begin{frame}{Common Mistakes in E-R Diagrams (Cont.)}
    \centering
    \includegraphics[trim={5.5cm 14cm 2.4cm 4.5cm}, clip, width=0.8\textwidth]{figures/incorrect_use2}
\end{frame}
...
\begin{frame}{Entities vs. Relationship sets}
    \begin{itemize}
        ...
        \includegraphics[trim={5cm 18.5cm 0cm 4cm}, clip, width=0.8\textwidth]{figures/registration}
