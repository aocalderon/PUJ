...
We expect you to submit a well-structured report in PDF format, containing the requested information outlined in Sections \ref{sec:beer} and \ref{sec:pizza}. Additionally, include the \texttt{radb} code with the answers to the queries in a ZIP file. The submission deadline is \textbf{February 26, 2026} before \textbf{11:00am}.
