...
Consolidate both the PDF report and the \texttt{.sql} file into a single ZIP archive for submission via Brightspace\texttrademark. The submission must be completed before the start of the lab session on \textbf{March 19, 2026}.
