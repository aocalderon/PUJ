...
\title{Databases \\ Lab 09: A still `gentle' Introduction to E-R Modelling.}
...
You do not need to submit the diagrams for Section~\ref{sec:try}, only for Section~\ref{sec:exercises}. Please include your diagrams in a well-structured report and submit it before \textbf{April 30, 2025}. Submit your report in \textbf{PDF format} via the corresponding Brightspace\texttrademark ~assignment.
