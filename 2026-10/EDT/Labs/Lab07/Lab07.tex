...
\title{Lab 06: A ``gentle'' Introduction to Artificial Neural Networks in R}
...
The architecture of a multilayer feed-forward network consists of an input layer, one or more hidden layers, and an output layer.
