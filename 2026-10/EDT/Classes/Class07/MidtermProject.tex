...
Students should choose a combination of the following methods:
...
\centering
\small
\begin{tabular}{lp{3.5cm}p{6.5cm}}
\toprule
\textbf{Method} & \textbf{Best For...} & \textbf{Technique} \\ \midrule
...
Post-Classification & Land Use Change & Perform a Supervised Classification (Random Forest or SVM) on both $t_1$ and $t_2$, then create a ``From-To'' change matrix. \\ \bottomrule
\end{tabular}
\end{table}
