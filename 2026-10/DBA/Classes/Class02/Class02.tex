...
\subtitle{Lecture 02: What is Metadata?}
...
\begin{frame}{Database Administration: What is Metadata?.}
    \centering
    \includegraphics[width=0.3\textwidth]{figures/book_cover2.jpg}
    \includegraphics[width=0.26\textwidth]{figures/book_cover3.jpg} \\
    \vspace{5mm}
    {
        \tiny
...
\begin{frame}{Metadata}
    ...
    \end{itemize}
    \centering
    \includegraphics[width=0.65\textwidth]{figures/metadata1}
\end{frame}
...
\begin{frame}{Metadata}
    ...
    \end{itemize}
    \centering
    \includegraphics[width=0.65\textwidth]{figures/metadata2}
\end{frame}
...
\begin{frame}{Metadata}
    ...
    \end{itemize}
    \centering
    \includegraphics[width=0.40\textwidth]{figures/metadata3}
\end{frame}
...
\begin{frame}{Photo Metadata}
    \centering
    \includegraphics[width=0.75\textwidth]{figures/photometa}
\end{frame}

\begin{frame}{Books}
    \centering
    \fbox{\includegraphics[width=0.35\textwidth]{figures/book}}
\end{frame}
\begin{frame}{Book Metadata}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/bookmeta}
\end{frame}

\begin{frame}{Blogs}
    \centering
    \includegraphics[width=0.7\textwidth]{figures/blog}
\end{frame}
\begin{frame}{Blog Metadata}
    \centering
    \includegraphics[width=.6\textwidth]{figures/blogmeta}
    \vspace{-5mm}
...
\begin{frame}{Emails}
    \centering
    \includegraphics[width=0.6\textwidth]{figures/email}
\end{frame}
\begin{frame}{Email Metadata}
    \centering
    \includegraphics[width=0.6\textwidth]{figures/emailmeta}
\end{frame}

\begin{frame}{Documents}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/document}
\end{frame}
\begin{frame}{Document Metadata}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/documentmeta}
\end{frame}
...
\begin{frame}{Code}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/code}
\end{frame}
\begin{frame}{Code Metadata}
    \centering
    \includegraphics[width=0.75\textwidth]{figures/codemeta}
\end{frame}

\begin{frame}{Databases}
    \centering
    \begin{tikzpicture}[remember picture]
        \path (0,10) node {\includegraphics[width=0.8\textwidth]{figures/db}};\pause
        \path (0,10) node {\includegraphics[width=0.4\textwidth]{figures/qm}};\pause
        \path (0,10) node {\includegraphics[width=0.45\textwidth]{figures/dbmeta}};
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Metadata Characteristics\footnote{Australian Research Data Commons}}
    ...
    \begin{minipage}{.49\textwidth}
        \begin{itemize}
            \item Metadata is information about an \textit{\textbf{object}} or \textit{\textbf{resource}} that describes \textit{\textbf{characteristics}} of that object, such as content, quality, format, location, and access rights.\pause
            \item Metadata can be used to describe \textit{\textbf{physical}} objects (e.g. samples and specimens) as well as \textit{\textbf{digital}} objects (e.g. documents, images, datasets and software).\pause
            \item Metadata can take many \textit{\textbf{different forms}}, from free text (e.g. a read-me file) to standardised, structured, machine-readable, extensible content.\pause
        \end{itemize}
    \end{minipage}
    \begin{minipage}{.49\textwidth}
        \begin{itemize}
            \item Metadata is \textit{\textbf{analogous to any other form of data}}, in terms of how it is created, managed, linked and stored.\pause
            \item Metadata is \textit{\textbf{associated with}} the data it describes.  It can be \textit{\textit{embedded}} within the data file, or \textit{\textbf{recorded a separated}} text/spreadsheet file that is linked to the collection of data files it describes, or contained in a catalogue record that points to the research data collection.\pause
            \item Metadata \textit{\textbf{enables}} and \textit{\textbf{enhances}} the \textit{\textbf{discovery}} and \textit{\textbf{reuse}} of data.\pause
        \end{itemize}
    \end{minipage}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Is a database administration tool.
        \item It is a type of metadata itself.
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Relationships among data elements.
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \texttt{pg\_database}: columns start with \texttt{dat} (e.g., \texttt{datname}).
            \item \texttt{pg\_proc}: columns start with \texttt{pro}.
            \item \texttt{pg\_namespace}: columns start with \texttt{nsp}.
            \item \texttt{pg\_class}: columns start with \texttt{rel} (stores information about tables and other objects with columns, referred to as ``relations'').
        \end{itemize}
    \end{itemize}
\end{frame}
