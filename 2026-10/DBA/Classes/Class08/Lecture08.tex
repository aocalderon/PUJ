...
\begin{frame}{Database Administration: SQL Functions.}
    \centering
    \includegraphics[width=0.33\textwidth]{figures/book_cover}\\
    \vspace{2mm}
    {
        \footnotesize
...
\begin{frame}{Function Volatility Categories}
  ...
  \begin{tabular}{|l|c|l|l|}
    \hline
    \textbf{Category} & \textbf{Can Modify DB?} & \textbf{Result for Same Input} & \textbf{Optimizer Behavior} \\ \hline
    VOLATILE & Yes & Can change (Default) & Re-evaluates every row \\ \hline
    STABLE & No & Same within transaction & Can optimize to single call \\ \hline
    IMMUTABLE & No & Constant forever & Pre-evaluates constants \\ \hline
  \end{tabular}
\end{frame}
