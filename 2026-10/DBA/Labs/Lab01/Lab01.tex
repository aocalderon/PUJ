...
We expect you to submit a well-structured report in PDF format, along with a dump file (a plain text with .sql extension) of the fixed MRD, packaged in a ZIP file, by \textbf{February 16, 2025 before 2:00PM}, via the link that will be provided on Brightspace.
